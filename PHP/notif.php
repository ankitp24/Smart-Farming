...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../plugins/images/sf1.png">
...
<body class="fix-header">
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.php">
                        ...
                        <!--This is dark logo icon--><img src="../plugins/images/sf1.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="../plugins/images/sf1.png" alt="home" class="light-logo" />
                     </b>
                        <!-- Logo text image you can use text also --><span class="hidden-xs">
                        <!--This is dark logo text--><img src="admin2.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="admin2.png" alt="home" class="light-logo" />
                     </span> </a>
                </div>
                <!-- /Logo -->
  ...
  <div class="alert alert-success alert-dismissable">
   <strong>Info!</strong> Fertilizers for wheat now available.
  ...
  <br>
   ...
   <strong>Alert!</strong> Predictions of drought in Jalgaon. Be wary of your crops!
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
  </div>
  <br>

    <div class="alert alert-warning alert-dismissable">
   <strong>Info!</strong>Keep yourself updated with the new retail prices of sugarcane.
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
  </div>
  <br>
